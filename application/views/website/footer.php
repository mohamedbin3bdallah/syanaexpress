        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="d-flex flex-wrap flex-lg-nowrap justify-content-between">
                    ...
                    <div class="f-col">
                        <h6 class="fw-bold mb-4"><?php echo $this->lang->line('services'); ?> </h6>
                        <ul>
                            <li><a href="<?php echo base_url($lang.'/categories'); ?>"> <?php echo $this->lang->line('categories'); ?> </a></li>
                            <li><a href="<?php echo base_url($lang.'/#about'); ?>"><?php echo $this->lang->line('aboutus'); ?> </a></li>
                            <li><a href="<?php echo base_url($lang.'/contact'); ?>"> <?php echo $this->lang->line('contactus'); ?> </a></li>

                        </ul>
                    </div>
                    <div class="f-col">
                        <h6 class="fw-bold mb-4"> <?php echo $this->lang->line('legal'); ?> </h6>
                        <ul>
                            <li><a href="javascript:;"> <?php echo $this->lang->line('termandcondition'); ?> </a></li>
                            <li><a href="javascript:;"> <?php echo $this->lang->line('privacypolicy'); ?> </a></li>
                            <li><a href="javascript:;"> <?php echo $this->lang->line('securityandmanagement'); ?> </a></li>

                        </ul>
                    </div>
                    <div class="f-col">
                        <h6 class="fw-bold mb-4"> <?php echo $this->lang->line('subscribenewsletter'); ?> </h6>
						<?php
							$attributes = array('method' => 'POST');
							echo form_open($lang.'/subscribe_post', $attributes);
							//echo validation_errors();
						?>
						<div><?php echo form_error('emailsub'); ?></div>
...
<div class="bottom-footer">
    <div class="container-xxl">
        ...
        <script src="<?php echo base_url('/assets/website/js/all.js'); ?>"></script>

		<!-- Modal -->
		<div id="success" class="modal fade" role="dialog">
			<div class="modal-dialog">
			<!-- Modal content-->
				<div class="modal-content" style="height:500px; background-color:#ececf1;">
					<div class="page-body">
						<div class="head" style="text-align:center;">  
							<h3 style="margin-top:15px;"><?php echo $this->lang->line('actiondonesuccessfully'); ?></h3>
							<h4 style="padding-top:15%;"><?php echo $this->lang->line($_SESSION['message']); ?></h4>
						</div>
						<div style="text-align:center;">
							<img src="<?php echo base_url('/assets/website/images/checked.png'); ?>" style="width:250px;" />
						</div>
					</div>
				</div>
			</div>
