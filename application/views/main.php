						...
						<tr>
							<td data-bgcolor="bg-module" bgcolor="#eaeced">
								<table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
									<tr>
										<td class="img-flex"><img src="<?php echo base_url('assets/email/exp-logo.jpg'); ?>" style="vertical-align:top;" width="600" height="306" alt="" /></td>
									</tr>
									<tr>
										<td data-bgcolor="bg-block" class="holder" style="padding:58px 60px 52px;" bgcolor="#f9f9f9">
											<table width="100%" cellpadding="0" cellspacing="0">
												<tr>
													...
													<?php echo get_phrase('express_maintenances'); ?>
													<br>
													 <?php echo get_phrase('express_maintenance'); ?>
													</td>
												</tr>
												<tr>
