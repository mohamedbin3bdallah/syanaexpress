<div class="main-panel">
  ...
  <div class="row">
    <div class="col-12 grid-margin">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title"><?php echo get_phrase('edit_city'); ?></h4>
           <?php $attributes = array('id' => 'form_validation', 'class'=> 'form-sample'); echo form_open_multipart('Place/updateCity/'.$city->id, $attributes); ?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
					<?php
						...
						echo form_dropdown('country', $ourtypes, array('country'=>$city->country_id), 'class="form-control"');
					?>
			...
			<div class="row">
              <div class="col-md-12">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
					<?php
						echo form_dropdown('active', ['0'=>get_phrase('not_active'), '1'=>get_phrase('active')], array('active'=>$city->active), 'class="form-control"');
					?>
