        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"><?php echo get_phrase('add_manager'); ?></h4>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="col-md-8">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="email" name="email" value="<?php echo set_value('email'); ?>" class="form-control" required="" placeholder="Enter Email" />
                            ...
                            <select class="form-control" name="role" required="">
                                ...
                                <?php 
                                 foreach ($role as $roledata) {
									 $selected = (set_value('role') == $roledata->id)? 'selected':'';
                ...
                <td>
                 <div class="btn-group dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo base_url('/Admin/change_status_admin');?>?id=<?php echo $admin->id; ?>&status=1&request=2"><i class="fa fa-reply fa-fw"></i><?php echo get_phrase('active'); ?></a>
                    <a class="dropdown-item" href="<?php echo base_url('/Admin/change_status_admin');?>?id=<?php echo $admin->id; ?>&status=0&request=2"><i class="fa fa-history fa-fw"></i><?php echo get_phrase('deactive'); ?></a>
                    <a class="dropdown-item" href="<?php echo base_url('Admin/editmanager/').$admin->id ?>"><i class="fa fa-history fa-fw"></i><?php echo get_phrase('edit'); ?></a>
                  </div>
                </div>
                </td>
              </tr>
