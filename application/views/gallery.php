                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="javascript:void(0);" class=" waves-effect waves-block"><?php echo get_phrase('action'); ?></a></li>
                                        <li><a href="javascript:void(0);" class=" waves-effect waves-block"><?php echo get_phrase('another_action'); ?></a></li>
                                        <li><a href="javascript:void(0);" class=" waves-effect waves-block"><?php echo get_phrase('something_else_here'); ?></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
